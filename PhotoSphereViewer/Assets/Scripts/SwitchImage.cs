...
public class SwitchImage : MonoBehaviour {
	...
	public void switchBackgroundImage() {
		...
		switch (currentLevel) {
		case 1:
			storeThis.stored = "http://i.imgur.com/hXen5YC.jpg";
			Application.LoadLevel( currentLevel);
			break;
		case 2:
			storeThis.stored = "http://i.imgur.com/f5mqp.jpg";
			Application.LoadLevel( currentLevel);
			break;
		case 3:
			storeThis.stored = "http://droidviews.com/wp-content/uploads/2013/06/Photosphere-Photo.jpg";
			Application.LoadLevel( currentLevel);
			break;	
		}
